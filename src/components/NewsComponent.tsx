  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative bg-white/90 backdrop-blur-2xl rounded-3xl border border-white/60 shadow-2xl shadow-blue-500/20 p-8 
          hover:bg-white/95 transition-all duration-300">
          
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500/30 to-purple-500/20 flex items-center justify-center shadow-lg">
              <span className="text-blue-600 text-2xl">🐳</span>
            </div>
            <h2 className="text-2xl font-bold bg-gradient-to-r from-slate-900 via-blue-900 to-slate-700 bg-clip-text text-transparent">TAPPs Whale - Complete Overview</h2>
          </div>
          ...
          <div className="mt-6 mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-2xl bg-white/50 backdrop-blur-sm border border-blue-200/50 shadow-lg">
              <div className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-2">Multi‑Chain</div>
              <div className="text-sm font-semibold text-slate-900">TON → SUI • BSC • SOL • ETH</div>
            </div>
            <div className="p-4 rounded-2xl bg-white/50 backdrop-blur-sm border border-purple-200/50 shadow-lg">
              <div className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-2">Community‑Powered</div>
              <div className="text-sm font-semibold text-slate-900">Meme-first culture • Whale circle</div>
            </div>
            <div className="p-4 rounded-2xl bg-white/50 backdrop-blur-sm border border-green-200/50 shadow-lg">
              <div className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-2">Early Access</div>
              <div className="text-sm font-semibold text-slate-900">Buy & Sell Program before listing</div>
            </div>
          </div>

          <div className="mb-8 flex flex-col gap-3 min-w-[200px]">
            <a href="https://t.me/TAPPs_Chat" target="_blank" rel="noopener noreferrer" className="w-full text-center px-6 py-3 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white text-sm font-semibold shadow-lg hover:shadow-xl transition-all">Join Telegram</a>
            <a href="https://x.com/TAPP_Whale" target="_blank" rel="noopener noreferrer" className="w-full text-center px-6 py-3 rounded-2xl bg-white/50 hover:bg-white/70 text-slate-800 text-sm font-semibold border border-slate-200/50 shadow-lg hover:shadow-xl transition-all">Follow on X</a>
          </div>
        
          {/* Executive Summary */}
          <div className="mb-8 p-6 rounded-2xl bg-gradient-to-r from-blue-50/50 to-purple-50/50 border border-blue-200/50 shadow-lg">
            <h3 className="text-xl font-semibold text-blue-900 mb-3 flex items-center gap-2">💡 Executive Summary</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-white/70 rounded-xl shadow-md">
                <div className="text-xl font-bold text-blue-600">0% VC</div>
                <div className="text-sm text-slate-600 font-medium">VC Allocation</div>
              </div>
              <div className="text-center p-4 bg-white/70 rounded-xl shadow-md">
                <div className="text-xl font-bold text-blue-600">40%</div>
                <div className="text-sm text-slate-600 font-medium">Community Mining</div>
              </div>
              <div className="text-center p-4 bg-white/70 rounded-xl shadow-md">
                <div className="text-xl font-bold text-blue-600">Multi-chain</div>
                <div className="text-sm text-slate-600 font-medium">TON + Expansion</div>
              </div>
              <div className="text-center p-4 bg-white/70 rounded-xl shadow-md">
                <div className="text-xl font-bold text-blue-600">100%</div>
                <div className="text-sm text-slate-600 font-medium">Transparent</div>
              </div>
            </div>
          </div>
          ...
          {/* Roadmap */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-slate-900 mb-6 flex items-center gap-2">🧭 TAPPs Roadmap</h3>
            <div className="space-y-6">
              <div className="rounded-2xl border border-blue-200/50 p-6 bg-white/50 backdrop-blur-sm shadow-lg">
                <div className="text-base font-semibold text-slate-900 mb-3">📍 Phase 1 — TON Launch (Now Live!)</div>
                <ul className="mt-3 text-sm text-slate-700 list-disc pl-6 space-y-2">
              ...
              <div className="rounded-2xl border border-purple-200/50 p-6 bg-white/50 backdrop-blur-sm shadow-lg">
                <div className="text-base font-semibold text-slate-900 mb-3">📍 Phase 2 — Multi‑Chain Expansion</div>
                <ul className="mt-3 text-sm text-slate-700 list-disc pl-6 space-y-2">
              ...
              <div className="rounded-2xl border border-green-200/50 p-6 bg-white/50 backdrop-blur-sm shadow-lg">
                <div className="text-base font-semibold text-slate-900 mb-3">📍 Phase 3 — Ecosystem Utility</div>
                <ul className="mt-3 text-sm text-slate-700 list-disc pl-6 space-y-2">
              ...
              <div className="rounded-2xl border border-orange-200/50 p-6 bg-white/50 backdrop-blur-sm shadow-lg">
                <div className="text-base font-semibold text-slate-900 mb-3">📍 Phase 4 — Global Recognition</div>
                <ul className="mt-3 text-sm text-slate-700 list-disc pl-6 space-y-2">
                  <li>CEX Listings</li>
          ...
          {/* Problem & Solution */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-slate-900 mb-6 flex items-center gap-2">🎯 Problem & Solution</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl bg-gradient-to-r from-red-50/50 to-pink-50/50 border border-red-200/50 shadow-lg">
                <h4 className="text-base font-semibold text-red-900 mb-3 flex items-center gap-2">❌ The Web3 Crisis</h4>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-r from-green-50/50 to-emerald-50/50 border border-green-200/50 shadow-lg">
                <h4 className="text-base font-semibold text-green-900 mb-3 flex items-center gap-2">✅ TAPPs Whale Solution</h4>
          ...
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-slate-900 mb-6 flex items-center gap-2">⚙️ Technical Architecture</h3>
            <div className="p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-slate-200/50 shadow-lg">
